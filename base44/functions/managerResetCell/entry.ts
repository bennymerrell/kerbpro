    ...
    await Promise.all(
      usersOnCell.map(u =>
        base44.asServiceRole.integrations.Core.SendEmail({
          to: u.email,
          subject: `Kerb: You have been logged out of ${cellDesc}`,
...
<tr><td style="padding:28px 32px;">
  ...
  <p style="margin:0 0 24px;font-size:15px;color:#374151;">Please open the Kerb app and log into a new cell to continue working.</p>
  <p style="margin:0;font-size:13px;color:#9ca3af;">This is an automated notification from Kerb.</p>
</td></tr>
